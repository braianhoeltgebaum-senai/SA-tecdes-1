...
// CORRIGIDO: import correto para readOnly = true funcionar
...
public class ExpedicaoService {
    ...
    public void processData(String ip, byte[] dadosClp4) {
        ...
        // Pedido concluído pela expedição
        if ((posicaoGuardadoExpedicao == posicaoGuardarExp) && !ocupadoExp && finishOPExp) {
            if (!SmartService.readOnly) {
