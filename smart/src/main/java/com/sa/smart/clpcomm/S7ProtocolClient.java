...
public class S7ProtocolClient {
    ...
    // Construtor para inicializar o cliente S7ProtocolClient com o IP e porta do
    // CLP
    ...
    public boolean connect() throws Exception {
        try {
            ...
            // System.out.println("Conexão estabelecida com o CLP: " + plcIpAddress + ":" +
            // port);
            return true;
        } catch (IOException e) {
    ...
    public void sendConnectionRequest() throws Exception {
        ...
        try {
            ...
            // length));
            if (length > 0) {
                // System.out.println("Resposta recebida da conexão: " +
    ...
    public void sendSetupCommunication() throws Exception {
        ...
        try {
            ...
            if (length > 0) {
                // System.out.println("Resposta recebida da configuração de comunicação: " +
                // Arrays.toString(response));
            } else {
                // System.out.println("Nenhuma resposta recebida.");
            }
        ...
        try {
            ...
            switch (type.toLowerCase()) {
                ...
                case "block" -> {
                    ...
                    // System.out.println("Retorno de Leitura [Block] DB="+db+" OFFSET="+offset+"
                    // SIZE="+size+" : " + bytesToHex(extractBlockFromResponse(response,
                    // size),size));
                }
                case "integer" ->
