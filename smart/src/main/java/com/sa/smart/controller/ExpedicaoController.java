...
public class ExpedicaoController {
    ...
    // PUT
    @PutMapping("/put/{id}")
    public ResponseEntity<ExpedicaoDTO> put(@PathVariable Long id, @RequestBody ExpedicaoDTO dto) {
        return ResponseEntity.ok(service.put(id, dto));
    }

    // PATCH
    @PatchMapping("/patch/{id}")
    public ResponseEntity<ExpedicaoDTO> patch(@PathVariable Long id, @RequestBody ExpedicaoDTO dto) {
